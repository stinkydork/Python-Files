...
if __name__ == '__main__':
    ...
    r0_S, v0_S = OrbitPropagator.Kep2State(7200, 0, 0, 0, 0, 0, cb=ct.Earth)
    ...
    ob_S = OrbitPropagator(r0_S,v0_S,tspan,dt,cb=ct.Earth,ob=ct.CubeSat_TerpRaptor,perturbations=perturbations)
